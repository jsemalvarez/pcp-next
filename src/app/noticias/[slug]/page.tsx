  ...
  return {
    ...
    openGraph: {
      ...
      images: newsItem.photoId
        ? [
            {
              url: `https://res.cloudinary.com/dwhdla1b4/image/upload/w_1200,h_630,c_fill,q_auto,f_auto/v1749595725/pcp-images/${newsItem.photoId}`,
              width: 1200,
              height: 630,
              alt: newsItem.title,
            },
        ...
        <article className="bg-white dark:bg-gray-800 rounded-3xl overflow-hidden shadow-xl border border-gray-100 dark:border-gray-700 p-6 md:p-10 space-y-6">
          ...
          {newsItem.photoId && (
            <div className="relative aspect-video w-full rounded-2xl overflow-hidden shadow-md border border-gray-100 dark:border-gray-700">
              <img
                src={`https://res.cloudinary.com/dwhdla1b4/image/upload/w_1000,q_auto,f_auto/v1749595725/pcp-images/${newsItem.photoId}`}
                alt={newsItem.title}
